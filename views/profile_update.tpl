<form action="/{{user.username}}/?action=profile" method="POST" enctype="multipart/form-data">
		<table width="320" height="115" bgcolor="ACDAE5" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <td>
            	<input type="text" style="width:150px;height:22px" name="name" value="{{user.name}}"/>
    				</td>
        </tr>
        <tr>
						<td align="right" valign="middle">Gender:
            </td>            
            <td>
        ...
        <tr>
						<td align="right" valign="middle">Hometown:
            </td>            
            <td>
        ...
        <tr>            
        	  <td align="right" valign="middle">Avatar:
        	  </td>            
            <td>
