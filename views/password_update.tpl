...
<form action="/{{user.username}}/?action=password" method="POST">
    <table width="320" height="115" bgcolor="ACDAE5" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="right" valign="middle">Old Password:</td>
            <td><input type="password" style="width:150px;height:22px" name="old_pw" value=""/></td>
        </tr>
        <tr>
            <td align="right" valign="middle">New Password:</td>
            <td><input type="password" style="width:150px;height:22px" name="new_pw1" value=""/></td>
        </tr>
        <tr>
            <td align="right" valign="middle">New Password Confirm:</td>
            <td><input type="password" style="width:150px;height:22px" name="new_pw2" value=""/></td>
        </tr>
        <tr align="center" valign="middle">
